				...
				{this.state.askForUsername === true ?
					<div>
						...
						<div style={{ justifyContent: "center", textAlign: "center", paddingTop: "40px" }}>
							<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
								borderStyle: "solid",borderColor: "#bdbdbd",objectFit: "fill",width: "60%",height: "35%"}}></video>
						</div>
					</div>
					:
					<div className='containerr'>
						...
						<div className="containerr">
							...
							<Row id="main" className="flex-containerr" style={{ margin: 0, padding: 0 }}>
								<video id="my-video" ref={this.localVideoref}  autoPlay muted style={{
									borderStyle: "solid",borderColor: "black",margin: "20",objectFit: "fill",
									width: "90%",height: "90%"}}></video>
							</Row>
						</div>
					</div>
				}
